...
class Noinfo extends Component{
    ...
    render(){
        ...
        return (
            ...
            <div class="no-data  " id={"Info-nodata" + this.props.type}>
                <div class="d-flex px-3 " style={getStyleObjectFromString("position: relative; align-self:flex-start; opacity:30%;")}>
                ...
                <div class="d-flex  " style={getStyleObjectFromString("position: absolute; align-self:flex-baseline")}>
    
                    <span class="p-2">
                        <p>Aún no hay registros.</p>
    
    
                        <button type="button" class="btn btn-link" onClick={this.showForm}>¿Desea
                            registrar un nuevo
                            usuario?</button>
